...
const curadoria = {
  ...
  'reliquia-jardim-hesperides': {
    ...
    descricao: 'Uma base com pomar próprio. Vem com Área Médica 2 e Armazém 2, sem custo de manutenção. Quem descansa completamente dentro do jardim recupera Vida e Mana em dobro nesse descanso.',
    localizacao: 'A definir com o Mestre',
  ...
  'reliquia-calice-graal': {
    ...
    descricao: 'Uma vez por cena, gaste uma Ação Padrão para oferecer o cálice a uma criatura dentro do alcance. Ela recupera toda a Vida e toda a Mana, e remove uma maldição ou condição permanente.',
    ativacao: 'Ação Padrão, alcance adjacente',
    frequencia: '1/cena',
    efeito: 'Recupera toda Vida e Mana e remove uma maldição ou condição permanente',
  },
  'reliquia-frasco-pandora': {
    ...comum,
