import type { ICatalogo, IClasse, IRaca, IPericiaCatalogo, IUnicoJardim } from '../types/catalogo';
...
import unicosJardimData from '../../data/jardim/unicos.json';
...
export const UNICOS_JARDIM_CATALOGO = unicosJardimData as unknown as IUnicoJardim[];
