/* ─────────────────────────────────────────────────────────
   O Jardim RPG — Loja
   Import de conteúdo por arquivo JSON. Mesmo princípio do
   Mundo: sem senha, sem tags de desbloqueio — quem tem o
   arquivo, vê. Quem não tem, não vê.
   ───────────────────────────────────────────────────────── */

import { storage } from '../core/storage.js';
import { TIPOS_VALIDOS } from './categorias.js';

const CHAVE = 'loja-entradas';
