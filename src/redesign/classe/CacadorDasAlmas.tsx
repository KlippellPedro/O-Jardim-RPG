...
export const CacadorDasAlmas = ({ classe }: { classe: IClasse }) => {
  ...
  return (
    <div className={`min-h-screen ${tema.text} p-8 selection:bg-rose-500/30 overflow-hidden relative`}>
      {/* 3D WebGL Background */}
      <div className="fixed inset-0 z-0 bg-cover bg-center bg-no-repeat opacity-20 pointer-events-none" style={{ backgroundImage: "url('/assets/img/cacador-das-almas_class_fantasy_bg.webp')" }} />
