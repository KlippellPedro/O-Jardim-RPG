    ...
    <div className="min-h-screen text-green-50 p-8 selection:bg-green-500/30 overflow-hidden relative">
      ...
      <div className="max-w-5xl mx-auto relative z-10 pt-16">
        ...
        >
          ...
          >
            Gente com corpo de bicho. Você escolhe o animal, e a Morfologia decide se o personagem é ágil, robusto ou místico. Troca ideias simples com animais, o que está longe de significar que eles obedeçam. Fala Sumeriano.
          </motion.p>
        </motion.header>
