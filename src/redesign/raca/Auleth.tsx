  ...
  return (
    <div className="min-h-screen text-indigo-50 p-8 selection:bg-indigo-500/30 overflow-hidden relative">
      ...
      <div 
        ...
        style={{ backgroundImage: "url('/assets/img/auleth_fantasy_bg.webp')" }}
      >
      ...
      <div className="max-w-5xl mx-auto relative z-10 pt-16">
        ...
        >
          ...
          >
            Consciência vinda de fora, presa numa forma física que ela mesma escolhe manter fluida. Muda de tamanho e de rosto quando quer, domina duas áreas de estudo muito específicas e tem dificuldade para entender por que os outros ligam tanto para sentimentos.
          </motion.p>
        </motion.header>
