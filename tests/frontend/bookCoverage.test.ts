...
test('toda mecânica do sistema tem uma página', () => {
  const COBERTURA: Array<[string, string]> = [
    ...
    ['raridades-modificacoes', 'orçamento de raridade e modificações'],
    ['crafting', 'fabricar e reparar'],
    ['veiculos', 'condução, perseguição e combate veicular'],
    ['magia-fluxo', 'Fluxos, círculos, magias e manifestações'],
