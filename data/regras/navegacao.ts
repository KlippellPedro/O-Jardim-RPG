...
export const GRUPOS_NAVEGACAO: readonly GrupoNavegacaoRegras[] = [
  ...
  },
  {
    ...
    topicos: ['racas', 'classes', 'poderes-habilidades', 'pericias', 'treinar', 'entre-aventuras', 'xp', 'legados', 'aliados', 'frutos-implantes'],
    cor: 'border-sky-300/20 from-sky-400/10',
  },
  {
    id: 'combate',
    titulo: 'Combate',
    descricao: 'Turnos, dano, ferimentos, condições e como o corpo se recupera.',
    topicos: ['combate', 'tipos-de-dano', 'distancias', 'ferimentos', 'coreografia', 'descanso', 'condicoes', 'aflicoes'],
    cor: 'border-rose-300/20 from-rose-400/10',
  },
  {
    id: 'cenas',
    titulo: 'Cenas e Grupo',
    descricao: 'Agir junto, correr atrás de alguém, negociar duro e jogar na mesa ao vivo.',
    topicos: ['acoes-coletivas', 'ataques-combinados', 'perseguicao-a-pe', 'conflito-social', 'mesa-ao-vivo'],
    cor: 'border-orange-300/20 from-orange-400/10',
  },
  {
    id: 'magia',
